...
export default function (plop: NodePlopAPI, config: Partial<PlopGeneratorConfig> = {}) {
  ...
  plop.setGenerator('component', {
    ...
    actions: function (data) {
      try {
        ...
        // Общая структура для остальных слоёв
          ...
          actions.push({
            ...
            templateFile: resolve(
              ...
              data?.useMemo ? 'memoComponent.hbs' : 'componentPages.hbs'
            ),
          });
        ...
        PlopLogger.error(error as Error);
        throw error;
      }
    },
  });
